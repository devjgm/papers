...
standard *Civil-Time Library* ([D0205R0]). The current paper is proposing a
...
[D0205R0]. This library is implementable using only C++98, and requires no
language extensions.
...
described in the proposed Civil-Time Library ([D0205R0]). The Time-Zone Library
...
```cpp
#include <chrono>
#include "civil.h"  // See proposal [D0205R0]
